          ...
          <div className="max-w-7xl flex justify-between relative items-center slider-item h-full mx-auto">
            <div className="flex flex-col justify-between max-w-[500px] slider-content">
              <div className="max-w-md">
                <p className="text-6xl font-bold text-primary-black mb-20">
                  {index + 1}.
                </p>

                <h3 className="text-6xl font-bold text-primary-black mb-9">
                  {item.heading}
                </h3>

                <p className="text-xl text-primary-black mt-5">
                  {item.description}
                </p>
              </div>
            </div>
